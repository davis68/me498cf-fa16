"""
beamExample.py
Reproduce the cantilever beam example
"""
...
myViewport = session.Viewport(name='Cantilever Beam',
...
mySketch = myModel.ConstrainedSketch(name='beamSketch',
    sheetSize=250.)                               # approximate size
